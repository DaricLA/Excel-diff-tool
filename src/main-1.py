                    ...
                    for d in comparer.diffs:
                        ...
                        try:
                            if _owb and _nwb and d.get('sheet') in _owb.sheetnames:
                                ...
                                _cs = ''.join(ch for ch in d.get('address','') if ch.isalpha())
                                _rs = ''.join(ch for ch in d.get('address','') if ch.isdigit())
                                if _cs and _rs:
                                    _r, _c = int(_rs), _cifs(_cs)
                                    e['old_value'] = str(_owb[d['sheet']].cell(_r, _c).value)
                                    e['new_value'] = str(_nwb[d['sheet']].cell(_r, _c).value)
                                    e['old_numfmt'] = _owb[d['sheet']].cell(_r, _c).number_format
                                    e['new_numfmt'] = _nwb[d['sheet']].cell(_r, _c).number_format
                        except Exception: pass
                        _dd.append(e)
